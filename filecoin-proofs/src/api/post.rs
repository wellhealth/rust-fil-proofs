...
pub fn generate_winning_post_inner<Tree: 'static + MerkleTreeTrait>(
    post_config: &PoStConfig,
    randomness: &ChallengeSeed,
...
pub fn verify_winning_post<Tree: 'static + MerkleTreeTrait>(
    ...
    let gpu_index = 0;
    verify_winning_post_inner::<Tree>(post_config,randomness,replicas,prover_id, proof,gpu_index)
}
...
pub fn verify_winning_post_inner<Tree: 'static + MerkleTreeTrait>(
    post_config: &PoStConfig,
    randomness: &ChallengeSeed,
    replicas: &[(SectorId, PublicReplicaInfo)],
    prover_id: ProverId,
...
pub fn verify_window_post<Tree: 'static + MerkleTreeTrait>(
    ...
    let gpu_index = 0;
    verify_window_post_inner::<Tree>(post_config,randomness,replicas,prover_id,proof,gpu_index)
}
